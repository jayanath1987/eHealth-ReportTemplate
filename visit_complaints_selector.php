...
$model .= "                </tr>\n";
$model .= "                <tr>\n";
$model .= "                    <th>Sum: <input type=\"checkbox\" class=\"span2\" value=\"1\" name=\"sum\"></th>\n";
$model .= "                    <th></th>\n";
$model .= "                </tr>\n";
$model .= "                </thead>\n";
$model .= "            </table>\n";
...
$js .= "        var lookUpW = window.open(\"" . $url
    . "/\" + $(\"#{$id}_dpd1\").val() + \"/\" + $(\"#{$id}_dpd2\").val()+\"/\"+$(\"#VisitTypePrint\").val()+\"/\"+$(
                    'input:radio[name=visit_order]:checked').val()+\"/\"+$('input:checkbox[name=sum]:checked').val(), \"lookUpW\", params);\n";
$js .= "    }\n";
$js .= "</script>";
