		...
		<div class="row" style="margin-top: 55px; padding-bottom: 10px; padding-top: 15px;">
            ...
            <div class="panel panel-default"  >
                ...
                <div class="modal fade" id="performance" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                     aria-hidden="true"></div>
                <div class="modal fade" id="traumaDataBank" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                     aria-hidden="true"></div>
                <div class="modal fade" id="trauma-survelinace" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                     aria-hidden="true"></div>
            </div>
                        </td>
                      </tr>
